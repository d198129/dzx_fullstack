<template>
  <div class="vcWrap">
    <input type="number" name="" id="" v-for="n in len" :key="'codeInput' + n" v-model.trim.number="code[n-1]" @keydown="onkeydown(n)" @keyup="onkeyup(n)" :ref="'codeInput' + n">
  </div>
</template>
...
export default {
  data(){
    return {
      ...
      keyCode: [48,49,50,51,52,53,53,55,56,57,96,97,98,99,100,101,102,103,104,105,8,13]
    }
  },
  props: ['length'],
  methods: {
